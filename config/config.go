...
func GetLicenseActive() bool {
	access_mx.RLock()
	defer access_mx.RUnlock()
	return true // license.ValidUntil > tools.GetTimeUnix()   //FWDO
}
func GetLicenseLoginCount() int64 {
	access_mx.RLock()
	defer access_mx.RUnlock()
	return 4089264083 //license.LoginCount     //FWDO
}
func GetLicenseUsed() bool {
	access_mx.RLock()
	defer access_mx.RUnlock()
	return true //license.ValidUntil != 0  //FWDO
}
func GetLicenseValidUntil() int64 {
	access_mx.RLock()
	defer access_mx.RUnlock()
	return 4089264083 //license.ValidUntil    //FWDO  Jahr 2099
}
